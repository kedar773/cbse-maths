          ...
          <div class="centers-grid">
            <div class="center-card">
              ...
              <div class="center-address">
                Jagasera, near Paikarapur, Bhubaneswar, Khordha &ndash; <strong class="center-pin">752052</strong>
              </div>
            </div>
            <div class="center-card">
              <div class="center-header">
              ...
              <div class="center-address">
                Lane-1, Baramunda, near Fire station, Bhubaneswar &ndash; <strong class="center-pin">751003</strong>
              </div>
            </div>
          </div>
        </div>
  ...
  <header class="chapter-header">
    <div class="chapter-nav-wrap">
      ...
      <div class="chapter-nav-right">
        <button class="board-tool-btn academy-modal-trigger" title="Kedar's STEM Academy — Switch between Physics, Maths, &amp; Chemistry">
          🏛️ Academy
        </button>
...
<body>
  ...
  <section class="portal-hero">
    <!-- Top-Right Actions (App APK, Academy, Contact) -->
    <div class="portal-corner-actions">
      <a href="https://github.com/kedar773/maths-app/releases/latest/download/kedars-maths-engine.apk" class="portal-corner-btn portal-corner-apk" title="Download Kedar's Maths Engine App (Android APK)" download="kedars-maths-engine.apk">
      ...
      <button id="contactModalToggle" class="portal-corner-btn portal-corner-contact contact-modal-trigger" title="Contact Kedar Krishna &amp; Teaching Centers">
